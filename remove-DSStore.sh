...
# of issue will only occur on developer machine. If we want to fix the electron-builder, we'd need the codesign tools to ignore these hidden Apple Finder files.
